...
var fight = function(enemy) {
  ...
  while (playerInfo.health > 0 && enemy.health > 0) {
    ...
    //remove enemy's health by subtracting amount set in the playerInfo.Attack variable
      ...
      //if player is alive keep fighting
        if (playerInfo.health > 0) {
          //annnounce round
            ...
            //if we're not in the last enemy in the array
            if (playerInfo.health > 0 && i < enemyInfo.length - 1) {
              //ask if player want to use store before next round
...
var shop = function () {
  ...
  var playerInfo = {
    name: window.prompt("What is our robot's name?"),
    health: 100,
    attack: 10,
    money: 10,
    reset: function() {
